...
const Contact = () => {
	...
	const handleSubmit = (e) => {
		...
		emailjs
			.send(
				...
				{
					from_name: username,
					to_name: "Kartik Channe",
					reply_to: user_email,
					to_email: "channekartikg2003@gmail.com",
	...
	return (
			...
			<div className='relative z-0 bg-black w-screen min-h-screen flex flex-col mt-120'>   
  ...
  as="button"
  type="submit"
  className="w-full py-3 rounded-xl font-bold bg-gray-900 text-white shadow-md hover:bg-gray-800 transition-all duration-300"
  color="cyan"
  speed="5s"
>
